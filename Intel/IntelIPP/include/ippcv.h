...
IPP_DEPRECATED("is deprecated. This function is obsolete and will be removed in one of the future IPP releases. Use corresponding filter from ippIP domain.")\
...
//    pBufferSize              The pointer to the buffer size
*/
IPP_DEPRECATED("is deprecated. This function is obsolete and will be removed in one of the future IPP releases. Use ippiFilterScharrHorizMaskBorderGetBufferSize instead of this one")\
IPPAPI(IppStatus, ippiFilterScharrHorizGetBufferSize_8u16s_C1R,     (IppiSize roiSize, int* pBufferSize))

IPP_DEPRECATED("is deprecated. This function is obsolete and will be removed in one of the future IPP releases. Use ippiFilterScharrVertMaskBorderGetBufferSize instead of this one")\
...
IPP_DEPRECATED("is deprecated. This function is obsolete and will be removed in one of the future IPP releases. Use ippiFilterScharrHorizMaskBorder_8u16s_C1R instead of this one")\
...
IPP_DEPRECATED("is deprecated. This function is obsolete and will be removed in one of the future IPP releases. Use ippiFilterScharrVertMaskBorder_8u16s_C1R instead of this one")\
...
IPP_DEPRECATED("is deprecated. This function is obsolete and will be removed in one of the future IPP releases. Use ippiFilterScharrHorizMaskBorder_32f_C1R instead of this one")\
IPPAPI(IppStatus, ippiFilterScharrHorizBorder_32f_C1R, (const Ipp32f* pSrc, int srcStep,
                                      Ipp32f* pDst, int dstStep, IppiSize roiSize,
                                      IppiBorderType borderType, Ipp32f borderValue, Ipp8u* pBuffer))

IPP_DEPRECATED("is deprecated. This function is obsolete and will be removed in one of the future IPP releases. Use ippiFilterScharrVertMaskBorder_32f_C1R instead of this one")\
