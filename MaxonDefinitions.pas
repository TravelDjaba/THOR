...
uses Windows, Messages, SysUtils,  Classes, Graphics, Controls, Forms,
  ...
  ActiveX, Buttons;
{kann evtl gelöscht werden?    Variants,}
{ --------------------------------------------------------------------------
...
{Motion Info}
    ...
    function VCS_GetCurrentIsAveraged(KeyHandle: Longint; NodeID: Word; var pCurrentIsAveraged: Smallint; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_VCS_GetCurrentIsAveraged@16';
...
{Data Recorder}
  ...
  {Data}
    ...
    function VCS_ReadChannelDataVector(KeyHandle: Longint; NodeID: Word; ChannelNumber: Byte; pDataVector: Pointer; VectorSize: Longint; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_ReadChannelDataVector@24';
